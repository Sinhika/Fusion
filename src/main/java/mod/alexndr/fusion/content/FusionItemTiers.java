...
{
	public static final TagKey<Block> BRONZE_TAG = 
		BlockTags.create(new ResourceLocation(Fusion.MODID, "needs_bronze_tool"));
	public static final TagKey<Block> STEEL_TAG = 
			BlockTags.create(new ResourceLocation(Fusion.MODID, "needs_steel_tool"));
	public static final TagKey<Block> SINISITE_TAG = 
			BlockTags.create(new ResourceLocation(Fusion.MODID, "needs_sinisite_tool"));
	public static final TagKey<Block> THYRIUM_TAG = 
			BlockTags.create(new ResourceLocation(Fusion.MODID, "needs_thyrium_tool"));
