...
public class FusionLootInjectorSubprovider extends LootTableInjectorProvider
{
    ...
    public void generate(BiConsumer<ResourceLocation, Builder> bar) 
    {
       ...
       addInjectionTable(bar, getInjectionTableId(Fusion.MODID, "abandoned_mineshaft"), foo);
       ...
       addInjectionTable(bar, getInjectionTableId(Fusion.MODID, "desert_pyramid"), foo);
        
        // igloo_chest
        foo = createChestPool(1, 1, 0.50F)
            .add(LootItem.lootTableItem(ModItems.bronze_shovel.get()).setWeight(1))
            .add(LootItem.lootTableItem(ModItems.steel_shovel.get()).setWeight(1));
       addInjectionTable(bar, getInjectionTableId(Fusion.MODID, "igloo_chest"), foo);
       ...
       addInjectionTable(bar, getInjectionTableId(Fusion.MODID, "jungle_temple"), foo);
        ...
        foo = createChestPool(1, 1, 0.50F)
            ...
            .add(LootItem.lootTableItem(ModItems.sinisite_ingot.get()).setWeight(1)
                    .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3))));
       addInjectionTable(bar, getInjectionTableId(Fusion.MODID, "simple_dungeon"), foo);
        ...
        foo = createChestPool(1, 1, 0.50F)
            ...
            .add(LootItem.lootTableItem(ModItems.sinisite_ingot.get()).setWeight(1)
                    .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3))));
       addInjectionTable(bar, getInjectionTableId(Fusion.MODID, "shipwreck"), foo);
        
        // spawn_bonus_chest
        foo = createChestPool(1, 1, 0.25F)
            .add(LootItem.lootTableItem(ModItems.bronze_axe.get()).setWeight(1))
            .add(LootItem.lootTableItem(ModItems.bronze_pickaxe.get()).setWeight(1));
       addInjectionTable(bar, getInjectionTableId(Fusion.MODID, "spawn_bonus_chest"), foo);
        ...
        foo = createChestPool(1, 1, 0.50F)
            ...
            .add(LootItem.lootTableItem(ModItems.steel_pickaxe.get()).setWeight(2))
            .add(LootItem.lootTableItem(ModItems.steel_shovel.get()).setWeight(2));
       addInjectionTable(bar, getInjectionTableId(Fusion.MODID, "stronghold"), foo);
        ...
        .add(LootItem.lootTableItem(ModItems.steel_ingot.get()).setWeight(5)
                .apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 4))));
       addInjectionTable(bar, getInjectionTableId(Fusion.MODID, "village_armorer"), foo);
        
        // village_fletcher
        foo = createChestPool(1, 1, 0.25F)
            .add(LootItem.lootTableItem(ModItems.thyrium_rod.get()).setWeight(1)
                    .apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 2))));
       addInjectionTable(bar, getInjectionTableId(Fusion.MODID, "village_fletcher"), foo);
        
        // village_mason
        foo = createChestPool(1, 1, 0.25F)
                .add(LootItem.lootTableItem(ModItems.bronze_pickaxe.get()).setWeight(1))
                .add(LootItem.lootTableItem(ModItems.steel_pickaxe.get()).setWeight(1));
       addInjectionTable(bar, getInjectionTableId(Fusion.MODID, "village_mason"), foo);
        
        // village_shepherd
        foo = createChestPool(1, 1, 0.25F)
            .add(LootItem.lootTableItem(ModItems.steel_shears.get()).setWeight(1));
       addInjectionTable(bar, getInjectionTableId(Fusion.MODID, "village_shepherd"), foo);
        ...
        foo = createChestPool(1, 1, 0.25F)
            ...
            .add(LootItem.lootTableItem(ModItems.steel_ingot.get()).setWeight(2)
                    .apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 4))));
       addInjectionTable(bar, getInjectionTableId(Fusion.MODID, "village_toolsmith"), foo);
        ...
        foo = createChestPool(1, 1, 0.25F)
                ...
                .add(LootItem.lootTableItem(ModItems.steel_ingot.get()).setWeight(2)
                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 4))));
       addInjectionTable(bar, getInjectionTableId(Fusion.MODID, "village_weaponsmith"), foo);
