...
public class ModInfo 
{
	...
	public static final String DEPENDENCIES = "required-after:simplecore@[1.5.2.1,);after:simpleores;after:netherrocks;after:jei@[4.5.0.0,)";
	...
	public static final String VERSIONURL = "https://raw.githubusercontent.com/Sinhika/Fusion/1.11/update.json";
